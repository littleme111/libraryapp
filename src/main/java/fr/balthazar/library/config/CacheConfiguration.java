package fr.balthazar.library.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(fr.balthazar.library.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(fr.balthazar.library.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
