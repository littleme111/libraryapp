...
import fr.balthazar.library.config.Constants;
import fr.balthazar.library.LibraryappApp;
import fr.balthazar.library.domain.Authority;
import fr.balthazar.library.domain.User;
import fr.balthazar.library.repository.AuthorityRepository;
import fr.balthazar.library.repository.UserRepository;
import fr.balthazar.library.security.AuthoritiesConstants;
import fr.balthazar.library.service.MailService;
import fr.balthazar.library.service.dto.UserDTO;
import fr.balthazar.library.web.rest.errors.ExceptionTranslator;
import fr.balthazar.library.web.rest.vm.KeyAndPasswordVM;
import fr.balthazar.library.web.rest.vm.ManagedUserVM;
import fr.balthazar.library.service.UserService;
