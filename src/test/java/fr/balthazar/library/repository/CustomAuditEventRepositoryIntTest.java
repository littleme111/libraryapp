...
import fr.balthazar.library.config.audit.AuditEventConverter;
import fr.balthazar.library.domain.PersistentAuditEvent;
...
import static fr.balthazar.library.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
